...
CREATE TABLE `IGDB_Collection` (
  `Id` bigint NOT NULL,
  `AsParentRelations` longtext NULL,
  `AsChildRelations` longtext NULL,
  `Checksum` varchar(45) DEFAULT NULL,
...
CREATE TABLE `IGDB_Game` (
  ...
  `ExpandedGames` longtext DEFAULT NULL,
  ...
  `LanguageSupports` longtext DEFAULT NULL,
  ...
  `Remakes` longtext DEFAULT NULL,
  `Remasters` longtext DEFAULT NULL,
